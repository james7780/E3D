...
// been able to test with this file yet.
...
#define GLFW_KEY_UP           (GLFW_KEY_SPECIAL+14)
#define GLFW_KEY_DOWN         (GLFW_KEY_SPECIAL+15)
#define GLFW_KEY_LEFT         (GLFW_KEY_SPECIAL+16)
#define GLFW_KEY_RIGHT        (GLFW_KEY_SPECIAL+17)
#define GLFW_KEY_LSHIFT       (GLFW_KEY_SPECIAL+18)
#define GLFW_KEY_RSHIFT       (GLFW_KEY_SPECIAL+19)
#define GLFW_KEY_LCTRL        (GLFW_KEY_SPECIAL+20)
#define GLFW_KEY_RCTRL        (GLFW_KEY_SPECIAL+21)
#define GLFW_KEY_LALT         (GLFW_KEY_SPECIAL+22)
#define GLFW_KEY_RALT         (GLFW_KEY_SPECIAL+23)
#define GLFW_KEY_TAB          (GLFW_KEY_SPECIAL+24)
#define GLFW_KEY_ENTER        (GLFW_KEY_SPECIAL+25)
#define GLFW_KEY_BACKSPACE    (GLFW_KEY_SPECIAL+26)
#define GLFW_KEY_INSERT       (GLFW_KEY_SPECIAL+27)
#define GLFW_KEY_DEL          (GLFW_KEY_SPECIAL+28)
#define GLFW_KEY_PAGEUP       (GLFW_KEY_SPECIAL+29)
#define GLFW_KEY_PAGEDOWN     (GLFW_KEY_SPECIAL+30)
#define GLFW_KEY_HOME         (GLFW_KEY_SPECIAL+31)
#define GLFW_KEY_END          (GLFW_KEY_SPECIAL+32)
#define GLFW_KEY_KP_0         (GLFW_KEY_SPECIAL+33)
#define GLFW_KEY_KP_1         (GLFW_KEY_SPECIAL+34)
#define GLFW_KEY_KP_2         (GLFW_KEY_SPECIAL+35)
#define GLFW_KEY_KP_3         (GLFW_KEY_SPECIAL+36)
#define GLFW_KEY_KP_4         (GLFW_KEY_SPECIAL+37)
#define GLFW_KEY_KP_5         (GLFW_KEY_SPECIAL+38)
#define GLFW_KEY_KP_6         (GLFW_KEY_SPECIAL+39)
#define GLFW_KEY_KP_7         (GLFW_KEY_SPECIAL+40)
#define GLFW_KEY_KP_8         (GLFW_KEY_SPECIAL+41)
#define GLFW_KEY_KP_9         (GLFW_KEY_SPECIAL+42)
#define GLFW_KEY_KP_DIVIDE    (GLFW_KEY_SPECIAL+43)
#define GLFW_KEY_KP_MULTIPLY  (GLFW_KEY_SPECIAL+44)
#define GLFW_KEY_KP_SUBTRACT  (GLFW_KEY_SPECIAL+45)
#define GLFW_KEY_KP_ADD       (GLFW_KEY_SPECIAL+46)
#define GLFW_KEY_KP_DECIMAL   (GLFW_KEY_SPECIAL+47)
#define GLFW_KEY_KP_ENTER     (GLFW_KEY_SPECIAL+48)
...
// thread)
#define GLFW_MAX_NUM_THREADS 100
...
GLFWAPI int  GLFWAPIENTRY glfwReadImage( char *name, GLFWimage *img, int flags );
GLFWAPI void GLFWAPIENTRY glfwFreeImage( GLFWimage *img );
GLFWAPI int  GLFWAPIENTRY glfwLoadTexture2D( char *name, int flags );
